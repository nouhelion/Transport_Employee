...
public class connect_driver extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_connect_driver);
        back = (ImageView) findViewById(R.id.back);
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(connect_driver.this, MainActivity.class);
        ...
        mAuth.signInWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()) {
                    //redirect to welcome
                    Intent intent = new Intent(connect_driver.this, tencours_driver.class);
                    startActivity(intent);
                } else {
                    Toast.makeText(connect_driver.this, "failed to connect! try again!", Toast.LENGTH_LONG).show();
                }
            }
        });
    }
