...
public class informations_driver extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_informations_driver);

        menu=(ImageView) findViewById(R.id.menu);
        menu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(informations_driver.this,navigation_bar_driver.class);
            ...
            db.collection("conducteur")
                    ...
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            Toast.makeText(informations_driver.this, "Modification Réussie", Toast.LENGTH_LONG).show();
                        }
                    });
        }
    }
